...
export async function login(email: string, password: string, fallback = "Login failed"): Promise<Me> {
...
export async function register(email: string, password: string, displayName?: string, fallback = "Registration failed"): Promise<Me> {
